...
export const modulesRepository = {
  ...
  list: (params?: ListParams) =>
    serverFetch.get<IPaginatedResponse<IModuleApplication>>('/api/access_control/modules', {
      params,
      revalidate: 120,
      tags: [accessControlTags.modulesApplications()],
    }),

  // Get module by ID
  getById: (id: string | number) =>
    serverFetch.get<IModuleApplication>(`/api/access_control/modules/${id}`, {
      revalidate: 300,
      tags: [accessControlTags.modulesApplications()],
    }),

  // Create module
  create: (payload: ICreateModuleApplication) =>
    serverFetch.post<IModuleApplication>('/api/access_control/modules', payload, {
      revalidate: false,
    }),

  // Update module
  update: (id: string | number, payload: IUpdateModuleApplication) =>
    serverFetch.put<IModuleApplication>(`/api/access_control/modules/${id}`, payload, {
      revalidate: false,
    }),
  ...
  // Get active modules
  getActive: () =>
    serverFetch.get<IModuleApplication[]>('/api/access_control/modules/active', {
      revalidate: 60,
      tags: [accessControlTags.modulesApplications()],
    }),
} as const;
...
export const moduleApplicationsRepository = {
  ...
  list: (params?: ListParams) =>
    serverFetch.get<IPaginatedResponse<IModuleApplication>>('/api/access_control/modules-applications', {
      params,
      revalidate: 120,
      tags: [accessControlTags.modulesApplications()],
    }),
  ...
  getById: (moduleId: string | number) =>
    serverFetch.get<IModuleApplication>(`/api/access_control/modules-applications/${moduleId}`, {
      revalidate: 300,
      tags: [accessControlTags.modulesApplications()],
    }),
  ...
  getApplicationsByModule: (moduleId: string | number) =>
    serverFetch.get<IApplication[]>(`/api/access_control/modules-applications/module/${moduleId}`, {
      revalidate: 120,
      tags: [accessControlTags.modulesApplications()],
    }),
  ...
  getModulesByApplication: (applicationId: string | number) =>
    serverFetch.get<IModuleApplication[]>(`/api/access_control/modules-applications/application`, {
      revalidate: 300,
  ...
  getActiveApplications: (moduleId: string | number) =>
    serverFetch.get<IApplication[]>(`/api/access_control/modules-applications/module/${moduleId}/active`, {
      revalidate: 120,
      tags: [accessControlTags.modulesApplications()],
    }),
  ...
  create: (payload: ICreateModuleApplication) =>
    serverFetch.post<IModuleApplication>(`/api/access_control/modules-applications`, payload, {
      revalidate: false,
    }),

  // Update module-application relationship
  update: (moduleId: string | number, payload: IUpdateModuleApplication) =>
    serverFetch.put<IModuleApplication>(`/api/access_control/modules-applications/${moduleId}`, payload, {
      revalidate: false,
    }),

  // Delete module-application relationship
  delete: (moduleId: string | number) =>
    serverFetch.delete<void>(`/api/access_control/modules-applications/${moduleId}`, {
      revalidate: false,
    }),
} as const;
...
export const moduleConfigRepository = {
  ...
  list: (moduleId: string | number, applicationId?: string | number, params?: ListParams) =>
    serverFetch.get<IPaginatedResponse<IModuleConfig>>(
      applicationId
        ? `/api/access_control/modules/${moduleId}/applications/config`
  ...
  // Get config by key
  getByKey: (moduleId: string | number, key: string) =>
    serverFetch.get<IModuleConfig>(`/api/access_control/modules/${moduleId}/applications/config/${key}`, {
      revalidate: 300,
      tags: [accessControlTags.modulesApplications()],
    }),

  // Create config
  create: (moduleId: string | number, payload: ICreateModuleConfigPayload) =>
    serverFetch.post<IModuleConfig>(`/api/access_control/modules/${moduleId}/applications/config`, payload, {
      revalidate: false,
    }),

  // Update config
  update: (moduleId: string | number, key: string, payload: IUpdateModuleConfigPayload) =>
    serverFetch.put<IModuleConfig>(`/api/access_control/modules/${moduleId}/applications/config/${key}`, payload, {
      revalidate: false,
    }),

  // Delete config
  delete: (moduleId: string | number, key: string) =>
    serverFetch.delete<void>(`/api/access_control/modules/${moduleId}/applications/config/${key}`, {
      revalidate: false,
    }),
} as const;
...
//       params,
//       revalidate: 120,
//       tags: [accessControlTags.modulesApplications(moduleId)],
//     }),
...
//   checkAllHealth: () =>
//     serverFetch.get<IBulkModuleApplicationHealthResponse>('/api/access_control/modules/health/bulk', {
//       revalidate: 30,
//       tags: [accessControlTags.modulesApplications()],
//     }),
...
//     serverFetch.get<IPaginatedResponse<IModuleApplicationHealth>>(`/api/access_control/modules/${moduleId}/health/history`, {
//       params,
//       revalidate: 300,
//       tags: [accessControlTags.modulesApplications(moduleId)],
//     }),
